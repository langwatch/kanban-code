...
public class LocalProcess {
    ...
    func childProcessRead (done: Bool, data: DispatchData?, errno: Int32) {
        ...
        if usesMainQueue {
            ...
            // async instead of sync: the pty read thread never blocks
            // waiting for the main thread. Data accumulates in the delegate's
            // buffer and gets processed in batches.
            dispatchQueue.async {
